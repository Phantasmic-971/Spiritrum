...
namespace Spiritrum.MagnoliaAddon.Items.Other
{
    public class Stormfish : ModItem
    {
        ...
        public override void AnglerQuestChat(ref string description, ref string catchLocation)
        {
            ...
            description = "I've heard of a fish that can emit lightning, I need you to aquire me one NOW! If you get electrocuted thats on you!";
            // What it says on the bottom of the angler's text box of how to catch the fish.
            catchLocation = "Caught during hardmode";
        }
    }
}
